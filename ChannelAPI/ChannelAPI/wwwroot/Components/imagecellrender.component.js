...
var ImageCellRendererComponent = ImageCellRendererComponent_1 = function () {
    ...
    ImageCellRendererComponent.prototype.refresh = function (params) {
        ...
        ImageCellRendererComponent_1.getLogo(this.params.value, this._channelLogoService).subscribe(function (img) {
            _this.image = img;
        });
        return true;
    };
...
__decorate([core_1.ViewChild('logo'), __metadata("design:type", core_1.ElementRef)], ImageCellRendererComponent.prototype, "logoEle", void 0);
ImageCellRendererComponent = ImageCellRendererComponent_1 = __decorate([core_1.Component({
    selector: 'logo-cell',
...
}), __metadata("design:paramtypes", [channellogo_service_1.ChannelLogoService])], ImageCellRendererComponent);
