...
var ChannelComponent = function () {
    function ChannelComponent(_channelService, _channelLogoService) {
        ...
        this.gridOptions = {
            getRowNodeId: function (data) {
                return data.id + data.region + data.num;
            }
        };
        this.showGrid = true;
    ...
    ChannelComponent.prototype.createRowData = function () {
        ...
        this._channelService.getBy('api/channel/vho/', this.vho).map(function (arr) {
            ...
            _this.gridOptions.api.setRowData(_.uniqBy(chb, function (ch) {
                return [ch.num, ch.region].join();
            }));
            _this.gridOptions.api.hideOverlay();
        }, function (error) {
            return _this.msg = error;
        });
    };
    ChannelComponent.prototype.createColumnDefs = function () {
        ...
        this.columnDefs = [{
            ...
            cellClass: function (params) {
                return params.value = 'center-cell';
            },
    ...
    ChannelComponent.prototype.vhoSelect = function (vhoName) {
        ...
        if (this.vho != vho) if (this.vho != vho) {
            this.vho = vho;
            this.createRowData();
    ...
    ChannelComponent.prototype.flexWidth = function (width) {
        ...
        if (rowHeight != this.gridOptions.rowHeight) this.gridOptions.api.resetRowHeights();
    };
    ChannelComponent.prototype.fitGridHeight = function (height) {
        ...
        if (chDetailHeight > height * .2) chDetailHeight = height * .2;
    ...
    ChannelComponent.prototype.loadChannel = function (fiosid, region) {
        ...
        this._channelService.getBy('api/channel/', fiosid).finally(function () {
            if (_this.updateChannel) {
                ...
                if (_this.editLogoForm.isSuccess) _this.gridOptions.api.redrawRows({ rowNodes: rowNodes });
                _this.updateChannel = false;
            }
        }).subscribe(function (x) {
            _this.channel = x.filter(function (y) {
                return y.strFIOSRegionName == region;
            }).pop();
        });
    };
    ChannelComponent.prototype.loadVhos = function () {
        ...
        this._channelService.get('api/region/vho').finally(function () {
            console.log("loadVhos => finally");
            if (!_this.vho && _this.vhos) _this.vhoSelect(_this.vhos[0]);
        }).subscribe(function (x) {
            _this.vhos = x;
        }, function (error) {
            return _this.msg = error;
    ...
    ChannelComponent.prototype.updateLogoCell = function ($id) {
        ...
        this.gridOptions.api.forEachNodeAfterFilterAndSort(function (node) {
            ...
            _this._channelService.getBriefBy($id).subscribe(function (ch) {
                node.setData(ch);
            }, function (error) {
                return _this.msg = error;
            }, function () {
...
__decorate([core_1.ViewChild(editlogo_component_1.EditLogoForm), __metadata("design:type", editlogo_component_1.EditLogoForm)], ChannelComponent.prototype, "editLogoForm", void 0);
__decorate([core_1.HostListener('window:resize', ['$event']), __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], ChannelComponent.prototype, "onWindowResize", null);
ChannelComponent = __decorate([core_1.Component({
    selector: 'channel-manager',
    templateUrl: 'app/Components/channel.component.html'
}), __metadata("design:paramtypes", [channel_service_1.ChannelService, channellogo_service_1.ChannelLogoService])], ChannelComponent);
