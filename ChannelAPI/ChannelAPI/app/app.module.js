...
AppModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.ReactiveFormsModule, http_1.HttpModule, app_routing_1.routing, ng2_bs3_modal_1.Ng2Bs3ModalModule, main_1.AgGridModule.withComponents([
                header_component_1.HeaderComponent
            ])],
        declarations: [app_component_1.AppComponent, channel_component_1.ChannelComponent, channellogo_component_1.ChannelLogoComponent, order_by_pipe_1.OrderBy, header_component_1.HeaderComponent],
